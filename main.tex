...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Software Development Intern}{June 2023 -- Present}
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Open Data Service} $|$ \emph{Go, Chi Router, PostgreSQL, Logrus}}{June 2020 -- Present}
          \resumeItemListStart
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Protein Folding Optimization} $|$ \emph{C, Pthreads, Performance Tuning and Analysis}}{May 2018 -- May 2020}
          \resumeItemListStart
            \resumeItem{Developed a program to calculate the maximum number of H-H contacts in a given n-length protein, exhaustively walking of every possible protein fold.}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Java, C/C++/C\#, Go, SQL (Postgres, MySQL), Arm Assembly, LaTeX} \\
     \textbf{Frameworks}{: .NET Framework, ASP.NET Core, Next.JS, OpenCL} \\
