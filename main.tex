...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{MonopoLeaderboards} $|$ \emph{JavaScript, HTML/CSS, MySQL, Node.js}}{November 2023 -- January 2024}
          \resumeItemListStart
            \resumeItem{Developed a web application to record and track statistics for Monopoly games, featuring a Node.js backend and MySQL database.}
            \resumeItem{Designed and deployed a MySQL server to securely store and manage all game data and player information.}
            \resumeItem{Built a frontend for the Monopoly game using HTML, CSS, and JavaScript, integrating with the backend services for a seamless user experience.}
            \resumeItem{Configured the project for remote development and deployment using SourceSync and SSH configurations, handling both frontend and backend services across different servers.}
          \resumeItemListEnd
      \resumeProjectHeading
